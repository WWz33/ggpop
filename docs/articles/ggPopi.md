...
| GWAS Q-Q | [`import_gwas()`](https://wwz33.github.io/ggPopi/reference/import_gwas.md) | [`plot_qq()`](https://wwz33.github.io/ggPopi/reference/plot_qq.md) | `ggpop() + ggPopi::geom_qq()` | internal fastqq-style layout |
...
| Introgression | [`import_introgression()`](https://wwz33.github.io/ggPopi/reference/import_introgression.md) | [`plot_introgression()`](https://wwz33.github.io/ggPopi/reference/geom_introgression.md) | `ggpop() + geom_introgression()` | Dsuite local/trio statistics, ADMIXTOOLS f-stat tables, and TreeMix summaries |
...
ld_decay <- import_ld_decay(
  ggpop_extdata("ld_decay", "poplddcay"),
  type = "poplddecay"
)
...
significance
thresholds.](ggPopi_files/figure-html/unnamed-chunk-3-1.png)
...
style.](ggPopi_files/figure-html/unnamed-chunk-4-1.png)

The same pattern applies across modules:

``` r
gwas |> ggpop() + ggPopi::geom_qq()
```
...
line.](ggPopi_files/figure-html/unnamed-chunk-5-1.png)
...
groups.](ggPopi_files/figure-html/unnamed-chunk-5-2.png)
...
3.](ggPopi_files/figure-html/unnamed-chunk-5-3.png)
...
population groups.](ggPopi_files/figure-html/unnamed-chunk-7-1.png)
...
labels used for
ordering.](ggPopi_files/figure-html/unnamed-chunk-7-2.png)
...
scale.](ggPopi_files/figure-html/unnamed-chunk-9-1.png)
...
chr2L.](ggPopi_files/figure-html/unnamed-chunk-10-1.png)
...
population label.](ggPopi_files/figure-html/unnamed-chunk-11-1.png)
...
the decay pattern.](ggPopi_files/figure-html/unnamed-chunk-12-1.png)
...
label.](ggPopi_files/figure-html/unnamed-chunk-13-1.png)
...
x-axis.](ggPopi_files/figure-html/unnamed-chunk-14-1.png)

## Introgression

Introgression summaries use the same direct and layered plotting shape.
Windowed Dsuite localFstats/Dinvestigate outputs default to
chromosome-wise window points on a Manhattan-like genome axis. Dsuite
BBAA/Dmin trio summaries default to P2-by-P3 matrix/raster views, with
ordered forest/lollipop summaries available through `style = "trio"`.
ADMIXTOOLS qpdstat, f3, and f4ratio outputs are imported as trio
statistic summaries and drawn as forest/lollipop panels with
standard-error bars when available. TreeMix internal edge/treeout
outputs are shown as lightweight graph summaries; matching vertices
files preserve the TreeMix drift-coordinate layout.

The bundled example below is a compact Dsuite localFstats window table.
It is meant for plotting examples; production analyses should import the
real Dsuite, ADMIXTOOLS, or TreeMix output files.
...
genome.](ggPopi_files/figure-html/unnamed-chunk-15-1.png)
...
over the genome.](ggPopi_files/figure-html/unnamed-chunk-16-1.png)
...
are aliases for the same API. The bundled SMC++ example follows the
Acropora-style CSV shape and uses `pop_group.txt` population labels
(`PopA`-`PopD`) with biologically plausible bottleneck and recovery
trajectories plus bootstrap paths.
...
main curves.](ggPopi_files/figure-html/unnamed-chunk-17-1.png)
...
![Layered demographic history plot using ggpop plus
geom_demographic_history. Population-specific SMC++ curves are drawn on
log-scaled time and Ne axes with bootstrap trajectories behind the main
curves.](ggPopi_files/figure-html/unnamed-chunk-18-1.png)
...
- Use [`plot_qq()`](https://wwz33.github.io/ggPopi/reference/plot_qq.md)
  and `ggpop() + ggPopi::geom_qq()` for Q-Q plots.
- Use
...
- Use
  ...
  /
  [`plot_demographic_history()`](https://wwz33.github.io/ggPopi/reference/geom_ne_history.md)
  and `ggpop() + geom_ne_history()` /
  [`geom_demographic_history()`](https://wwz33.github.io/ggPopi/reference/geom_ne_history.md)
  for effective population size histories.
